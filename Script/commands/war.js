...
module.exports.run = async function({ api, args, Users, event}) {
 ...
 a("নিলোয় কে যে গালি দিবি তার আম্মু রে চুদি মাগির পোলা !");
 setTimeout(() => {a({body: "এই মুরগি খাংকির পোলা নিলোয় তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস" })}, 3000);
 ...
 setTimeout(() => {a({body: "খাংকির পোলা তুইই নিলোয় কে গালি দেস তুই তো রাস্তার পতিতার পুত ছোডো ভাই তর আম্মু রে টুস করে চুদে দিয়ে দূর দিভো 🐒🙈?" })}, 12000);
 ...
 setTimeout(() => {a({body: "আমি নিলোয় 👉করলাম শুরু তোর মার পুটকিতে ডুকামু ২টা গরু গরু নাকি ডাকে হাম্বা তোর মার ভোদায় ডুকামু ২টা ইলেক্ট্রিকের খাম্বা" })}, 20000);
 ...
 setTimeout(() => {a({body: "তর আম্মু রে আমি চুদি রাস্তায় চুদে বাঘ চুদে বনে তোর মায়ের কালা ভোদা চুদমু আমি ঘরের এক কনে 👒শুয়ারের বাচ্চা।গালি দেস নিলোয় রে কত সাহস" })}, 25000);
 ...
 setTimeout(() => {a({body: "নীলোয় কে গালি চুদাস মাগির পো খাংকির পোলা খাংকির পোলা তর মায়্রে চুদি খাংকির পোলা" })}, 39000);
 ...
 setTimeout(() => {a({body: "নীলোয় নাম যদি হয় রং তোর মা চুদার সময় অনেক করে ঢংক" })}, 85000);
 ...
 setTimeout(() => {a({body: "নিলয় তর আব্বু মাথায় রাখবি মাগির পোলা লেভেল হীনé" })}, 95000);
 ...
 setTimeout(() => {a({body: "মুরগি আব্বু ডাক ওকে নিলয় তর রিয়েল পাপ্পা বাতিজা, 😒😒"})} , 115000);
}
